...
var plot = module.exports.plot = function(){
  ...
  Object.keys(args).forEach(function(key,i){
    if (key == '0'){
      ...
      yStr += '{fillColor:"rgba('+r+','+g+','+b+',0.2)",strokeColor: "rgba('+r+','+g+','+b+',1)",pointColor: "rgba('+r+','+g+','+b+',1)",pointStrokeColor: "#fff",pointHighlightFill: "#fff",pointHighlightStroke:"rgba('+r+','+g+','+b+',1)",data:['+args[key]+']},'
  ...
  var head = '<html><head><meta http-equiv="Pragma" content="no-cache"><meta http-equiv="cache-control" content="max-age=0" /><meta http-equiv="cache-control" content="no-cache" /><meta http-equiv="expires" content="0" /><meta http-equiv="expires" content="Tue, 01 Jan 1980 1:00:00 GMT" /><meta http-equiv="pragma" content="no-cache" /><script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/1.0.1/Chart.min.js"></script><style type="text/css">canvas{margin:5em;}</style></head><body><canvas id="myChart" width="700" height="400"></canvas><script type="text/javascript">var ctx = document.getElementById("myChart").getContext("2d");var data = {labels:';
  var tail =']};var myLineChart = new Chart(ctx).Line(data,{responsive:true});</script></body></html>';
  html = head +'['+ xStr + '], datasets: [' + yStr + tail;
